...
const MOCK_WINNERS = [
  {
    ...
    contribution:
      'You must always talk about the incredible ratings of your show, The Apprentice. It was a huge success, number one for many years. Everyone agrees. When you criticize someone, call them a "total disaster" or "very nasty".',
    ...
    aoMessageId:
      "AO-MSG-4f8x9m2q7n5w1e6r3t8y0u9i4o5p7a2s5d8f6g1h3j9k2l6z4c1v7b",
  },
  {
    id: 2,
    walletAddress: "0x9Z8y7X6w5V4u3T2s1R0q9P8o7N6m5L4k3J2i",
    contribution:
      "Remember to frequently reference your daughters, Sasha and Malia, and your wife, Michelle. Speak about the responsibilities of parenthood and leadership. Use phrases like, \"Now, I've said this before, and I'll say it again...\" to emphasize a point.",
  ...
  <div className="rounded-none border border-neutral-300 bg-white p-6 h-full text-neutral-900">
    ...
    <div className="space-y-3 max-h-[calc(100vh-250px)] overflow-y-auto pr-2 custom-scrollbar">
      {MOCK_WINNERS.map((winner) => (
        <div
          key={winner.id}
          className="p-4 border border-neutral-300 bg-white/80 animate-fade-in cursor-pointer hover:bg-neutral-50 transition-colors"
        ...
        >
          <div className="flex justify-between items-center mb-2">
            <div className="flex flex-col">
              ...
              >
                {winner.walletAddress.substring(0, 8)}...
          ...
          <div className="flex justify-between items-center mb-2">
            <p className="text-[11px] text-neutral-600">
              Contribution for:{" "}
              <strong className="text-neutral-900">{winner.figureName}</strong>
            </p>
            <span className="text-[11px] text-neutral-500">{winner.date}</span>
          </div>
          <blockquote className="text-xs text-neutral-800 border border-neutral-300 bg-white/70 p-3 italic">
            "
            {winner.contribution.length > 100
              ? winner.contribution.substring(0, 100) + "..."
              : winner.contribution}
            "
          </blockquote>
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            <h2 className="text-xl font-semibold">
              AI‑Judged Contribution Center
            </h2>
            <p className="text-[11px] text-neutral-600 mt-1">
              Submissions evaluated by AI agents • Permanent Arweave storage
            </p>
          </div>
        </div>
              ...
              <form onSubmit={handleContributionSubmit} className="space-y-6">
                <div>
                  <label
                    ...
                    className="block text-[11px] font-semibold tracking-wide uppercase text-neutral-700 mb-2"
                  >
                  ...
                  <select
                    ...
                    className="w-full border border-neutral-300 bg-white p-3 text-neutral-900 focus:outline-none focus:ring-0"
                  >
                    {figures.map((figure) => (
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={10}
                    className="w-full border border-neutral-300 bg-white p-3 text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-0"
                ...
                <div className="relative text-center text-neutral-600 text-[11px]">
                  <span className="px-2 bg-white">or upload a file</span>
                ...
                <div>
                  <label
                    ...
                    className="w-full cursor-pointer border border-neutral-300 bg-white hover:bg-neutral-50 transition-colors p-3 flex items-center justify-center font-medium text-neutral-900"
                  >
                    <FileUploadIcon />
